...
# Creates a new pipe (top and bottom)
def create_pipe():
...
# Draws the each pipe in the list of pipes
...
# Checks if bird went through pipes
...
# Bird initializer (self explanitory)
class Bird:
